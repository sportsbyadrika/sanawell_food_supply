...
<div class="text-lg font-bold"><?= $deliveredCount ?></div>
</div>

   <div class="border rounded-lg px-3 py-2 bg-red-100">
<div class="text-xs">Not Delivered</div>
<div class="text-lg font-bold"><?= $notDeliveredCount ?></div>
</div>

   <div class="border rounded-lg px-3 py-2 bg-orange-100">
